...
function App() {
  ...
  return (
    ...
    {alert && <div data-testid="attempt-to-divide-by-zero" id="attempt-to-divide-by-zero" className="display">You can't do this</div>
    }
    <div data-testid="calculated-total" id="calculated-total" className="display">{ calculatedTotal }</div>
    </div>
  );
}
